...
return testbed.module(function(params)
	return {
		...
		work_slots    = 14,
		inputs = {
			{ name = "addr_lo"       , index =  1, keepalive = 0x10000000, payload = 0x03FFFFFF, initial = 0x10000000 },
			{ name = "res_lo_addr_hi", index =  3, keepalive = 0x10000000, payload = 0x07FFFFFF, initial = 0x10000000 },
			{ name = "res_hi"        , index =  5, keepalive = 0x10000000, payload = 0x0000FFFF, initial = 0x10000000 },
			{ name = "bus_lo"        , index =  7, keepalive = 0x10000000, payload = 0x0003FFFF, initial = 0x10000000 },
			{ name = "bus_hi"        , index =  9, keepalive = 0x10000000, payload = 0x0000FFFF, initial = 0x10000000 },
			{ name = "res_rd"        , index = 11, keepalive = 0x10000000, payload = 0x0000001F, initial = 0x10000000 },
		...
		outputs = {
			...
			{ name = "res_rd"  , index =  5, keepalive = 0x10000000, payload = 0x0000001F },
