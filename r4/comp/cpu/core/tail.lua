...
return testbed.module(function(params)
	...
	return {
		...
		inputs = {
			...
			{ name = "rhs_lo", index = 10, keepalive = 0x10000000, payload = 0x0000FFFF, initial = 0x10000000 },
			{ name = "rhs_hi", index = 12, keepalive = 0x10000000, payload = 0x0000FFFF, initial = 0x10000000 },
		...
		outputs = {
			...
			{ name = "addr_lo", index =  9, keepalive = 0x10000000, payload = 0x0000FFFF },
			{ name = "addr_hi", index = 11, keepalive = 0x10000000, payload = 0x0000FFFF },
		},
